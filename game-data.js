  ...
  const archive = {
    ...
    nation: {
      ...
      sections: [
        ...
        ["人口与劳力", "驻军属于总人口。其余人口形成可用劳力，并按方案投入农业、商贸和征募；人口越多，基础产能越高，但粮食消耗也同步上升。"],
        ["粮仓与征募", "农业产出粮食并维持人口增长。粮仓耗尽后，领地会停止征募并损失平民；征募只把平民转为驻军，不增加总人口，驻军上限为人口的三成半。"],
        ["生产结算", "领地生产按完整小时结算，最多累计十二小时。切换劳力方案时会先按旧方案结算，防止把过去的产出回溯到新方案。"],
        ["防御", "玩家离线时主城不受攻击。若领地遭受重创且民众众志成城，有机会召唤愿望守护者。"]
      ],
      facts: [["劳力来源", "总人口减去驻军"], ["生产方案", "均衡、粮食、商贸、征募"], ["累计上限", "十二小时"], ["驻军上限", "总人口的 35%"], ["两种货币", "金币与生存币"], ["离线规则", "主城免受玩家攻击"]]
    },
    factions: {
      title: "阵营与活动",
    ...
    arena: {
      ...
      sections: [
        ["1v1 单线", "双方各有一座外塔与一座基地，小兵每八秒成波刷新。防御塔优先攻击进入范围的小兵；没有兵线掩护时强行越塔会承担极高风险。远距离点击进攻技能会锁定最近目标并自动接近。摧毁基地立即获胜，三分钟未结束则比较基地、外塔和击杀。"],
